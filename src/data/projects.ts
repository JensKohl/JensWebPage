...
export const projects: Project[] = [
{
        ...
        subtitle: 'First framework to allow testing agents on deeper technical level than acceptance tests',
        link: 'TODO',
        image: 'images/projects/AutomatedStructuralTestsPic.jpg',
        date: '2025-12-08',
        desc:   'Main author of an IEEE Big Data 2025 main-track paper introducing an open-source framework for structural testing of LLM-based agents. I ideated the overall approach ' + 
...
},
{
        ...
        date: '2025-03-05',
        desc:   'As part of a joint BMW and AWS team, we designed and built an LLM-based agent to automate incident root-cause analysis across distributed cloud services. ' +
...
},*/
{
        ...
        subtitle: 'A framework for increasing the quality of LLM-based applications over their whole life cycle',
        link: 'https://github.com/awslabs/generative-ai-toolkit',
        image: 'images/projects/GenAIToolkitArchitecture.png',
        date: '2023-12-01',
        desc:   'As part of a joint AWS and BMW team, I ideated and co-designed the Generative AI Toolkit, a framework that automates core workflows across the lifecycle '+
...
},
{
        ...
        desc:   'As part of a joint AWS and BMW team, I ideated and co-led the development of one of the first LLM-based multi-agent systems worldwide. The system optimizes cloud infrastructure ' +
...
},
{
        ...
        date: '2023-12-01',
        desc:   'As part of a joint BMW and AWS team, I ideated, co-led, and contributed to the development of an automated compliance framework enforcing internal standards and ' +
...
},
{
        ...
        subtitle: 'One of the first successful migrations of an automotive OEM to the cloud',
        ...
        image: 'images/projects/bmw-connected-drive-app-feature-reading-1024x518.jpg',
        date: '2023-05-04',
        desc:   'For 2 years, I led the team responsible for cloud architecture, architectural standards, and the migration initiative of BMW ConnectedDrive to AWS, covering over 1,300 microservices. ' +
...
},
{
        ...
        subtitle: 'Virtualize embedded Android control units on cloud compute instances',
        ...
        date: '2023-05-04',
        desc:   'Together with AWS and external partners, my team built a virtual ECU (vECU) platform on AWS, enabling fully end-to-end virtualization of embedded automotive Android devices and supporting ' +
...
},
{
        ...
        date: '2022-11-31',
        desc:   'I led the cross-functional prototyping team that developed what is, to the best of our knowledge, the first end-to-end automotive diagnosis workflow at scale. The workflow covers real-time ' +
...
},
{
        ...
        subtitle: 'Embedded Software Developer of Superbike\'s real-time embedded control unit for data logging and telemetry',
        link: '',
        image: 'images/projects/Superbike.jpg',
        date: '2005',
        desc:   'As part of BMW\'s professional Superbike racing team, I designed and implemented core modules of the Superbike\'s data logger, an embedded control unit in C/C++ on RTEMS. ' +
...
},
{
        ...
        date: '2004',
        desc:   'I developed a code-signing tool for the BMW M5 engine control unit (ECU) in C/C++, ensuring secure software and data set integration. Additionally, I designed and implemented a ' +
