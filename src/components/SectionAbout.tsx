...
const SectionAbout: React.FC = () => {
	...
	useEffect(() => {
		...
		fetch(`${import.meta.env.BASE_URL}docs/aboutMe.md`)
			.then((res) => {
					...
					{loading ? (
						...
						<ReactMarkdown
							components={{
								...
								h1: ({ children }) => (
									<h3 className="text-xl font-black uppercase tracking-tight text-[#333333] mt-10 mb-4">
										{children}
									</h3>
								),
								h2: ({ children }) => (
									<h4 className="text-lg font-bold uppercase tracking-wide text-[#333333] mt-8 mb-3">
										{children}
									</h4>
								),
