...
const ProfileCard: React.FC<ProfileCardProps> = ({ setActiveSection }) => {
  ...
  return (
    <aside
      ...
      className="w-full lg:w-[600px] lg:min-h-screen border-r border-[#eeeeee] bg-white p-10 flex flex-col items-start"
    >
      ...
      <div className="mb-14">
        ...
        <a 
          ...
          className="text-[14px] text-[#aaaaaa] hover:text-blue-600 transition-colors border-b border-transparent hover:border-blue-600 block w-fit font-medium" 
        >
          jens.kohl@gmx.de
        </a>
      </div>
      ...
      <div className="w-full mb-12">
        <div className="text-[#666666] text-[15px] leading-relaxed prose prose-sm max-w-none">
          <ReactMarkdown
            components={{
              h1: ({ ...props }) => <h1 className="text-[20px] font-bold uppercase tracking-tight text-[#333333] mt-0 mb-4 text-left" {...props} />,
              h2: ({ ...props }) => <h2 className="text-[13px] font-bold uppercase tracking-[0.2em] text-[#888888] mt-8 mb-3 text-left" {...props} />,
              ul: ({ ...props }) => <ul className="list-disc list-outside ml-5 mb-6 space-y-2 text-[#666666]" {...props} />,
              a: ({ ...props }) => <a {...props} className="text-[#333333] border-b border-[#dddddd] hover:border-black transition-all no-underline" />
            }}
          >
            {bio}
          </ReactMarkdown>
