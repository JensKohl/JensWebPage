      ...
      <div className="bg-white p-10 lg:p-16 shadow-[0_1px_3px_rgba(0,0,0,0.05)] border border-[#eeeeee]">
        ...
        <section className="mb-20">
          ...
          <div className="space-y-6 text-[15px] leading-relaxed text-[#555555]">
            <div>
              <p className="font-bold text-black uppercase text-[10px] tracking-widest mb-2">Provider</p>
              <p>Dr. Jens Kohl</p>
              <p>[Your Street Address]</p>
              <p>[Zip Code] [City], Germany</p>
            </div>
            <div>
              <p className="font-bold text-black uppercase text-[10px] tracking-widest mb-2">Contact</p>
