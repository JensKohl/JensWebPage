...
const SectionProjects: React.FC = () => {
	return (
		<section className="animate-fadeIn pb-20">
			{/* Unified White Box Container matching About, Resume, Contact, and Legal */}
			<div className="bg-white border border-[#eeeeee] p-8 shadow-sm transition-all">
				{/* 1. Header Section */}
				<header className="mb-10 border-b border-[#eeeeee] pb-6">
				...
				<div className="flex flex-col">
					...
					{projects.map((project) => (
						<article
							key={project.title}
							className="pb-16 mb-16 border-b border-[#eeeeee] last:border-b-0 last:mb-0 last:pb-0"
						>
							{/* Title */}
